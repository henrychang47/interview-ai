                    ...
                    <li key={question.id}>
                      <Card className="overflow-hidden transition-all hover:border-outline hover:shadow-calm-lg">
                        <div className="flex items-start gap-md border-b border-outline-variant bg-surface-container-low p-md">
                          <div
                            className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-label-md font-bold ${answer
                          ...
                          <div className="min-w-0 flex-1">
                            <h4
                              className={`text-body-lg font-semibold leading-8 ${answer ? 'text-on-surface' : 'text-on-surface-variant'
                                }`}
                            >
                              {question.text}
                            </h4>
